...
var $author$project$Main$Player = F4(
	function (id, name, avatar, score) {
		return {avatar: avatar, id: id, name: name, score: score};
	});
var $author$project$Main$init = {
	...
	players: _List_fromArray(
		[
			A4($author$project$Main$Player, 0, 'Robert', 'https://avatars2.githubusercontent.com/u/6553283?s=460&v=4', 10),
			A4($author$project$Main$Player, 1, 'Torbjørn', 'https://avatars2.githubusercontent.com/u/191559?s=400&v=4', 15)
		])
};
...
var $author$project$Main$addToPlayerScore = F3(
	function (id, value, players) {
		return A2(
			$elm$core$List$map,
			function (item) {
				return _Utils_eq(item.id, id) ? _Utils_update(
					item,
					{score: item.score + value}) : item;
			},
			players);
	});
		...
		switch (msg.$) {
			case 'Increment':
				...
				return _Utils_update(
					model,
					{
						players: A3($author$project$Main$addToPlayerScore, id, 2, model.players)
					});
			case 'InputName':
				var input = msg.a;
				return _Utils_update(
			...
			case 'InputAvatar':
				...
				return _Utils_update(
					...
					{newAvatar: input});
			default:
				return (($elm$core$String$length(model.newAvatar) > 0) && ($elm$core$String$length(model.newName) > 0)) ? _Utils_update(
					model,
					{
						newAvatar: '',
						newName: '',
...
var $author$project$Main$InputAvatar = function (a) {
	return {$: 'InputAvatar', a: a};
};
...
var $author$project$Main$renderNewPlayerForm = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$placeholder('Navn'),
										$elm$html$Html$Events$onInput($author$project$Main$InputName),
										$elm$html$Html$Attributes$value(model.newName)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$placeholder('Avatar'),
										$elm$html$Html$Events$onInput($author$project$Main$InputAvatar),
										$elm$html$Html$Attributes$value(model.newAvatar)
									]),
								_List_Nil)
							])),
						A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('pure-g box')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('pure-u-1-4')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src(player.avatar),
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(player.score))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Main$Increment(player.id))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('+')
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$map, $author$project$Main$renderPlayer, sorted))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$Main$renderNewPlayerForm(model)
					]))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Increment":["Basics.Int"],"InputName":["String.String"],"InputAvatar":["String.String"],"Submit":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));